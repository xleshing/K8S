...
# TEST_LIMIT_END = 100
IS_TRAIN = True  # True為訓練模型、False為測試模型

# 數據集路徑
TRAIN_DATASET_DIR = "dataset/Final_Training"  # 訓練資料路徑
TEST_DATASET_DIR = "dataset/Final_Test/Images"  # 測試資料路徑
# TRAIN_DATASET_DIR = "dataset/Train/50"  # 訓練資料路徑
# TEST_DATASET_DIR = "dataset/Test/250/Images"  # 測試資料路徑
...
# MODEL_LOAD_PATH = "Backup/model_backup/10_traffic_sign_cnn.pth"  # 加載模型路徑
